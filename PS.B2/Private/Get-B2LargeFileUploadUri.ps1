function Get-B2LargeFileUploadUri
{
<#
.SYNOPSIS
...
.OUTPUTS
    PS.B2.LargeFileUploadUri
    
        The cmdlet will output a PS.B2.LargeFileUploadUri object holding upload info.
.LINK
...
#>
    ...
    [Alias()]
    [OutputType('PS.B2.LargeFileUploadUri')]
    Param
    (
    ...
    Begin
    {
        ...
        [Uri]$b2ApiUri = "$ApiUri/b2api/v1/b2_get_upload_part_url"
    }
    Process
    {
        try
        {
            [String]$sessionBody = @{'fileId'=$FileID} | ConvertTo-Json
            ...
            Add-ObjectDetail -InputObject $bbReturnInfo -TypeName 'PS.B2.LargeFileUploadUri'
        }
        catch
        {
